      ...
      <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
        <div className='space-y-2'>
          <div className='flex items-center justify-between'>
            ...
            <button className='' onClick={closeConfirmTripModal}>
        ...
        <form className='space-y-3' onSubmit={createTrip}>
          <div className='h-14 px-4 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
            ...
            <input 
              name='name' 
              placeholder="Seu nome completo" className="bg-transparent text-lg placeholder:text-zinc-400 outline-none flex-1" 
            />
          </div>
          ...
          <div className='h-14 px-4 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
            ...
            <input 
              type="email" 
              name='email' 
              placeholder="Seu email" className="bg-transparent text-lg placeholder:text-zinc-400 outline-none flex-1" 
            />
          </div>
